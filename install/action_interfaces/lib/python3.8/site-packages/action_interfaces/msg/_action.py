...
class Action(metaclass=Metaclass_Action):
    ...
    def __init__(self, **kwargs):
        ...
        self.action = array.array('d', kwargs.get('action', []))
    ...
    def action(self, value):
        if isinstance(value, array.array):
            assert value.typecode == 'd', \
                "The 'action' array.array() must have the type code of 'd'"
            self._action = value
            return
        if __debug__:
        ...
        self._action = array.array('d', value)
