...
{
  new (message_memory) action_interfaces::msg::Action(_init);
}

void Action_fini_function(void * message_memory)
{
  auto typed_message = static_cast<action_interfaces::msg::Action *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Action_message_member_array[1] = {
  {
    ...
    offsetof(action_interfaces::msg::Action, action),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Action_message_members = {
  ...
  "Action",  // message name
  1,  // number of fields
  sizeof(action_interfaces::msg::Action),
...
{
  return &::action_interfaces::msg::rosidl_typesupport_introspection_cpp::Action_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, action_interfaces, msg, Action)() {
  return &::action_interfaces::msg::rosidl_typesupport_introspection_cpp::Action_message_type_support_handle;
}
