...
#include <stddef.h>
#include "action_interfaces/msg/detail/action__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  action_interfaces__msg__Action__init(message_memory);
}

void Action__rosidl_typesupport_introspection_c__Action_fini_function(void * message_memory)
{
  action_interfaces__msg__Action__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Action__rosidl_typesupport_introspection_c__Action_message_member_array[1] = {
  {
    ...
    offsetof(action_interfaces__msg__Action, action),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers Action__rosidl_typesupport_introspection_c__Action_message_members = {
  ...
  "Action",  // message name
  1,  // number of fields
  sizeof(action_interfaces__msg__Action),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, action_interfaces, msg, Action)() {
