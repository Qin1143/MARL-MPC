...
class MyRobotDriver:
    def init(self, webots_node, properties):
        ...
        self.__node = rclpy.create_node('mir_robot_3_driver')
        # self.__node.create_subscription(Twist, 'cmd_vel', self.__cmd_vel_callback, 1)
        self.__node.create_subscription(Motor, '/motor_cmd_3', self.__motor_callback, 1)
        self.__odom_pub = self.__node.create_publisher(Odometry, '/odom_3', 10)
